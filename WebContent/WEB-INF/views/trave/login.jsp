					...
					<td>
						<table id ="formTable" border="1">
							<tr >
								...
								<td>
									<input class="inputId"  data-type="userName" name="userName" value="" id="inputName" type="text" maxlength="5"  style="height: 22px;"/>
								</td>
							</tr>
							<tr>
								<td align="center" >
								...
								<td >
									<input  id="inputPhone"  data-type="userPhone" name="userPhone" type="text"  maxlength="11" autocomplete="off" style="height: 22px;"/>
								</td>
							</tr>
							<tr>
